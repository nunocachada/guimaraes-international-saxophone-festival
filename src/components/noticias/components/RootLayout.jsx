...
import { GridPattern } from '@/components/noticias/components/GridPattern'
import { Logo, Logomark } from '@/components/noticias/components/Logo'
import { Offices } from '@/components/noticias/components/Offices'
import { SocialMedia } from '@/components/noticias/components/SocialMedia'
...
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/noticias">Notícias</NavigationItem>
        <NavigationItem href="/about">Sobre nós</NavigationItem>
      </NavigationRow>
      {/* <NavigationRow>
        <NavigationItem href="/process">Nossa missão</NavigationItem>
