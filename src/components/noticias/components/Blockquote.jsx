...
function BlockquoteWithImage({ author, children, className, image }) {
  return (
    ...
    >
      <blockquote className="col-span-2 font-mono text-xl/7 text-neutral-500 sm:col-span-7 sm:col-start-6 sm:row-start-2">
      ...
      <figcaption className="font-mono text-sm text-neutral-500 sm:col-span-7 sm:row-start-3 sm:text-base">
  ...
  return (
    <Border position="left" className={clsx('pl-8', className)}>
      <figure className="font-mono text-sm">
        <blockquote className="text-neutral-500">
          {typeof children === 'string' ? <p>{children}</p> : children}
        </blockquote>
        <figcaption className="mt-6 font-semibold text-neutral-500">
