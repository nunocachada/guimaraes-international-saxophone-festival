  ...
  TopTip({ children, className }) {
    return (
      <Border position="left" className={clsx('my-10 pl-8', className)}>
        <p className="font-mono text-sm font-bold tracking-widest text-[#A87B3F] uppercase">
          Dica
        </p>
    ...
    return (
      <div
        className={clsx(
          ...
          '[&_h1]:mt-12 [&_h1]:mb-6 [&_h1]:font-syne [&_h1]:text-3xl [&_h1]:font-semibold [&_h1]:text-[#A87B3F] [&_h1]:first:mt-0',
          '[&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:font-syne [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-[#A87B3F]',
          '[&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:font-syne [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-[#A87B3F]',
          ...
          '[&_a]:text-[#A87B3F] [&_a]:underline [&_a]:hover:text-[#8B6A3F]',
          className,
        )}
        {...props}
      />
