...
export const MDXComponents = {
  ...
  wrapper({ className, ...props }) {
    return (
      <div
        className={clsx(
          'font-mono text-base leading-7 text-neutral-300',
          '*:mx-auto *:max-w-3xl [&>:first-child]:mt-0! [&>:last-child]:mb-0!',
          '[&_h1]:mt-12 [&_h1]:mb-6 [&_h1]:font-mono [&_h1]:text-3xl [&_h1]:font-semibold [&_h1]:text-sax-gold [&_h1]:first:mt-0',
          '[&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:font-mono [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-sax-gold',
          '[&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:font-mono [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-sax-gold',
          '[&_p]:mb-6 [&_p]:leading-7',
          '[&_ul]:mb-6 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-6',
          '[&_ol]:mb-6 [&_ol]:list-decimal [&_ol]:space-y-2 [&_ol]:pl-6',
          '[&_li]:mb-2',
          '[&_strong]:font-semibold [&_strong]:text-neutral-200',
