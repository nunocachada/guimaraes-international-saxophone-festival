  ...
  React.useEffect(() => {
    ...
    const compute = () => {
      ...
      if (responsive && containerRef.current) {
        // Use container dimensions for responsive mode
        const containerRect = containerRef.current.getBoundingClientRect();
        displayWidth = containerRect.width || width;
        displayHeight = containerRect.height || height;
      } else {
        // Use fixed dimensions
        displayWidth = width ?? img.naturalWidth;
        displayHeight = height ?? img.naturalHeight;
      }
