...
export const HeroHighlight = ({ children, className, containerClassName }) => {
  ...
  return (
    <div
      //retirei  h-[40rem] adicionei py-6
      className={cn(
        " group relative flex h-[full] w-[full] items-center justify-center bg-white dark:bg-black py-6",
        containerClassName
      )}
...
export const Highlight = ({ children, className }) => {
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-primary to-secondary px-1 pb-1 dark:from-primary dark:to-secondary`,
        className
      )}
    >
      {children}
