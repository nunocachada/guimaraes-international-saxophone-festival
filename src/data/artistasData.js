...
export const days = [
  ...
  },
  {
    ...
    atividades: [
      ...
      },
      {
        ...
        informacoes:
          'Colocar info  sobre as salas por exemplo, "Sala SI12 - Ties Mellema, Sala SI13 - Nicolas Arsenevich, Sala SI14 - Nuno Silva".',
      },
      {
  ...
  },
  {
    ...
    atividades: [
      ...
      {
        nome: 'Masterclasses',
        subtitulo: 'Prof. Ties Mellema / Prof. Nicholas Arsenevich',
        descricao:
          'Explicar o que é uma masterclass e descrever o caso específico destas aulas: duração etc',
        localizacao: 'Piso 2 do Teatro Jordão',
        horario: 'Vários horários ao longo do festival',
