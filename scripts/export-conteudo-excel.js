...
const days = [
  {
    ...
    artistas: [
      ...
      },
      {
        ...
        biografia:
          'Nicolas Arsenijevic é professor no CNSMP (Conservatoire National Supérieur de Musique et de Danse de Paris), França. Reconhecido internacionalmente pela sua excelência técnica e artística.',
        informacoes: 'em breve',
        eventos: [
          'Dia de Abertura - 7 de Julho',
      ...
      },
      {
        ...
        informacoes: 'em breve',
        eventos: [
          'Dia de Abertura - Stars of the Future (a confirmar)',
          'Workshops & Masterclasses - 9 de Julho',
  ...
  },
  {
    ...
    atividades: [
      ...
      },
      {
        ...
        descricao:
          'Explicar o que é uma masterclass e descrever o caso específico destas aulas: duração etc',
        localizacao: 'Piso 2 do Teatro Jordão',
        horario: 'Vários horários ao longo do festival',
        informacoes:
          'Colocar info sobre as salas por exemplo, "Sala SI12 - Ties Mellema, Sala SI13 - Nicolas Arsenijevic, Sala SI14 - Nuno Silva".',
      },
      {
      ...
      },
      {
        ...
        localizacao:
          'Pátio TJGA (Piso 1 – salas individuais) / Bandas de Garagem',
        horario: '13:10 - 13:30',
      },
      {
        nome: 'Masterclasses',
        subtitulo: 'Prof. Ties Mellema / Nicholas A.',
        descricao:
  ...
  },
  {
    ...
    atividades: [
      ...
      {
        nome: 'Stars of the Future',
        subtitulo: 'Henk van Twillert (second session)',
        descricao:
          'Programa dedicado aos jovens talentos do saxofone. Sessões especiais com Henk van Twillert para desenvolver e destacar os futuros astros do saxofone.',
        localizacao: 'Piso 2 do Teatro Jordão',
        horario: '11:30 - 12:30',
      ...
      {
        nome: 'Masterclasses',
        subtitulo: 'Prof. Ties Mellema / Prof. Nicholas Arsenijevic',
        descricao:
          'Explicar o que é uma masterclass e descrever o caso específico destas aulas: duração etc',
        localizacao: 'Piso 2 do Teatro Jordão',
        horario: 'Vários horários ao longo do festival',
      ...
      },
      {
        ...
        subtitulo: 'Ensaio',
        descricao:
          'EEEnsaios da All Sax Orchestra: grupo de música de câmara destinado a alunos de nível académico avançado. Os alunos serão colocados mediante o seu nível académico.',
        localizacao: 'Piso 2 do Teatro Jordão, Conservatório de Guimarães',
      },
      {
        ...
        subtitulo: 'Nicolas A.',
        descricao:
          'Concerto especial no Conservatório com Nicolas Arsenijevic. Uma apresentação única num espaço histórico e acústico excecional.',
  ...
  },
  {
    ...
    atividades: [
      {
        nome: 'Masterclass',
        subtitulo: 'Prof. Ties Mellema / Nuno S.',
        descricao:
          'Sessões de masterclass com professores renomados internacionalmente. Oportunidade única para aprender técnicas avançadas, interpretação e receber feedback personalizado dos melhores profissionais do saxofone.',
        localizacao: 'Piso 2 do Teatro Jordão',
        horario: 'Vários horários ao longo do festival',
...
async function run() {
  ...
  // —— Folha: Instruções ——
  const instSheet = workbook.addWorksheet('Instruções', {
  ...
  const artSheet = workbook.addWorksheet('Artistas', {
    views: [{ state: 'frozen', ySplit: 1 }],
  })
  const artHeaders = [
    'Nome',
    ...
    'Imagens (ficheiros, um por linha)',
  ]
  artSheet.columns = artHeaders.map((h, i) => ({
    header: h,
    key: `col${i}`,
    width: i === 3 ? 50 : i === 5 || i === 6 ? 30 : 18,
  }))
  ...
  daySheets.forEach((day) => {
    ...
    sheet.columns = actHeaders.map((h, i) => ({
      header: h,
      key: `col${i}`,
      width: i === 2 ? 50 : 22,
    }))
